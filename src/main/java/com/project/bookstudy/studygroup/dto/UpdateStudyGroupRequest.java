...
public class UpdateStudyGroupRequest {
    ...
    @Builder
    public UpdateStudyGroupRequest(int maxSize, String contents, String subject, int price, String contentsDetail, LocalDateTime studyStartDt, LocalDateTime studyEndDt, LocalDateTime recruitmentEndDt, LocalDateTime recruitmentStartDt) {
